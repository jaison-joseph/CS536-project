...
class customtopo(Topo):
	def build(self):
		...
		self.addLink(s5, s9, bw=0.1, max_queue_size=32)
		self.addLink(s2, s3, bw=0.01, max_queue_size=32)
		self.addLink(s3, s4, bw=0.04, max_queue_size=32)
		self.addLink(s7, s8, bw=0.04, max_queue_size=32)
		self.addLink(s4, s5, bw=0.04, max_queue_size=32)
		self.addLink(s8, s9, bw=0.04, max_queue_size=32)
		self.addLink(s6, s7, bw=0.01, max_queue_size=32)
		self.addLink(s0, s9, bw=0.01, max_queue_size=32)
		self.addLink(s3, s6, bw=0.1, max_queue_size=32)
		self.addLink(s0, s4, bw=0.04, max_queue_size=32)
		self.addLink(s5, s6, bw=0.01, max_queue_size=32)
		self.addLink(s0, s1, bw=0.01, max_queue_size=32)
		self.addLink(s1, s2, bw=0.1, max_queue_size=32)
		self.addLink(s1, s7, bw=0.01, max_queue_size=32)
		# END build
